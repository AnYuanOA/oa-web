...
public class OldOAToDoDetail {
    ...
    public void setAttL_ID(int attL_ID) {
    ...
    public float getRest_day_num() {
        return rest_day_num;
    }

    public void setRest_day_num(float rest_day_num) {
